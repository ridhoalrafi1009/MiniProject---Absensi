                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input name="created_at" class="form-control mb-2 input-credit-card"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="role">
                                            ...
                                            <option value="asissten"> Asisten </option>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        <label class="form-label">Join Date </label>
                                        <input name="created_atU" class="form-control mb-2 input-credit-card"
                                            type="date" placeholder="Join Date" />
                                    </div>
                                    @if ($role->role == 'admin' || $role->role == 'pj')
                                        <div class="form-group">
                                    ...
                                    @else
                                        <div class="form-group">
                                            <label class="form-label">Jabatan</label>
                                            <input name="roleU" class="form-control mb-2 input-credit-card"
                                                type="text" disabled readonly placeholder="Jabatan" />
                                        </div>
                                    @endif
                                    <label class="form-label">Photo</label>
                                    <div class="custom-file">
    ...
    <script>
        function getData(id) {
            axios.post("{{ route('editAsisten') }}", {
                ...
                $('input[name=created_atU]').val(res.data.created_at)
